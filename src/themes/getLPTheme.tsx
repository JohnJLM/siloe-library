      ...
      components: {
         ...
         MuiToggleButtonGroup: {
            styleOverrides: {
               root: ({ theme }) => ({
                  borderRadius: '10px',
                  boxShadow: `0 4px 16px ${brand[700]}`,
                  '& .Mui-selected': {
                     color: brand[500],
                  },
                  ...(theme.palette.mode === 'dark' && {
               ...
               root: ({ theme, ownerState }) => ({
                  ...
                  ...(ownerState.variant === 'contained' &&
                     ownerState.color === 'primary' && {
                        ...
                        backgroundImage: `linear-gradient(to bottom, ${'#2a7ed1'}, ${'#256eb5'})`,
                  ...
                  ...(ownerState.variant === 'contained' &&
                     ...
                     ownerState.disabled === true && {
                        color: '#000',
                        background: '#000',
                        backgroundImage: `linear-gradient(to bottom, ${'#b7b7b7'}, ${'#b7b7b7'})`,
                     }),
         ...
         MuiDialog: {
            styleOverrides: {
               paper: ({ theme }) => ({
                  backgroundColor: theme.palette.mode === 'light' ? `${gray[100]}` : `${gray[800]}`,
               }),
            },
         },
